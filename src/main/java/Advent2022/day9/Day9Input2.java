...
public class Day9Input2 {
    ...
    record Indexes(Integer headRow, Integer headColumn, int[] tailRow, int[] tailColumn) {
    }
...
//        Scanner scanner = new Scanner(new File("day9/a_sample.txt"));
        ...
        int currentHeadRow = 15;
        int currentHeadColumn = 11;
//        int currentTailRow = 4;
//        int currentTailColumn = 0;
        int[] currentTailRow = {15,15,15,15,15,15,15,15,15};
        int[] currentTailColumn = {11,11,11,11,11,11,11,11,11};
        for(int i=0; i< currentTailRow.length ; i++){
            pointsVisited.add(new Index(currentTailRow[i], currentTailColumn[i]));
        }
        ...
        while (scanner.hasNext()) {
            ...
            for(int i=0; i< currentTailRow.length ; i++) {
                ...
                currentTailRow[i] = indexes.tailRow[i];
                currentTailColumn[i] = indexes.tailColumn[i];
            }
        }
...
//        }
    ...
    private static Index moveTail(int currentHeadRow, int currentHeadColumn, int currentTailRow, int currentTailColumn) {
       ...
       // moveTail(currentHeadRow, currentHeadColumn, currentTailRow, currentTailColumn, );

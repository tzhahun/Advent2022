...
//        Scanner scanner = new Scanner(new File("day11/a_sample.txt"));
        ...
        int rounds = 20;
        BigDecimal worryyLevelReduction = new BigDecimal(3);
...
//                    inspectedCount.merge(currentProcessingMonkey, 1, Integer::sum);
                }
    ...
    private static BigDecimal processWorry(BigDecimal worryyLevelReduction, int currentMonkey, Operation op, BigDecimal item) {
        ...
        result = result.divide(worryyLevelReduction, RoundingMode.DOWN);

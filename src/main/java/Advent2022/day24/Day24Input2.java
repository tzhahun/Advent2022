...
public class Day24Input2 {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        Scanner scanner = new Scanner(new File("day24/input2.txt"));
//        Scanner scanner = new Scanner(new File("day24/a_sample.txt"));
        ...
        edges.add(new Position(destinationLocation.getRow() +1, destinationLocation.getColumn()));
        int countMoves = 0;

        Set<Position> possibleExpeditonLocations = new HashSet<>();
        possibleExpeditonLocations.add(startingExpeditionLocation);
        countMoves = getMoves(possibleExpeditonLocations, destinationLocation, countMoves);

        possibleExpeditonLocations = new HashSet<>();
        possibleExpeditonLocations.add(destinationLocation);
        countMoves = getMoves(possibleExpeditonLocations, startingExpeditionLocation, countMoves);
    ...
    private static int getMoves(Set<Position> possibleExpeditonLocations, Position startingExpeditionLocation, int countMoves) {
        while (!possibleExpeditonLocations.contains(startingExpeditionLocation)) {
            moveBlizzardsByOne();
